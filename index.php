                ...
                <div class="pricing-item" style="box-shadow: 0px 0px 30px -7px rgba(0,0,0,0.29);">
                    ...
                    <div class="pricing-button pb-4">
                        <lable class="btn btn-lg btn-primary w-75">
                           <input type="radio" name="amount" value="2500" class="btn btn-lg btn-primary w-25">Select plan
                        </lable>
                    </div>
                </div>
            </div>
...
<!-- Card #2, Intermediate -->
            <div class="col-lg-4 col-md-6 col-sm-10 pb-4 d-block m-auto">
                <div class="pricing-item" style="box-shadow: 0px 0px 30px -7px rgba(0,0,0,0.29);">
                    ...
                    <div class="pricing-button pb-4">
                        <lable class="btn btn-lg btn-primary w-75">
                           <input type="radio" name="amount" value="5000" class="btn btn-lg btn-primary w-25">Select plan
                        </lable>
                    </div>
                </div>
            </div>
...
<!-- Card #3, Professional -->
            <div class="col-lg-4 col-md-6 col-sm-10 pb-4 d-block m-auto">
                <div class="pricing-item" style="box-shadow: 0px 0px 30px -7px rgba(0,0,0,0.29);">
                    ...
                    <div class="pricing-button pb-4">
                    	<lable class="btn btn-lg btn-primary w-75">
                           <input type="radio" name="amount" value="10500" class="btn btn-lg btn-primary w-25">Select plan
                        </lable>
                    </div>
                </div>
            </div>
